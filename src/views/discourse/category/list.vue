    ...
    <div class="container mt-4" v-if="checkPermission(['discourse_view'])">
        <div class="card mb-2">
            <div class="card-header d-flex justify-content-between align-items-center mb-3">
                ...
                <router-link to="/discourse/categories/create" class="btn btn-primary">
        ...
        <b-table class="table table-bordered table-striped" striped hover :items="categories.data" :fields="fields">
            ...
            <template #cell(actions)="data">
                <router-link :to="`/discourse/categories/${data.item.id}/edit`" class="btn btn-sm btn-warning me-2">
                    <i class="bi bi-pen"></i>
