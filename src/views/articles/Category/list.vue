<template>
    <div class="container mt-3 mt-md-4 px-2 px-md-3" v-if="checkPermission(['articlecategory_view'])">
        ...
        <div class="card d-md-none">
            <div class="card-body p-2">
                <div class="article-category-cards">
                    <div
                        v-for="cat in categories.data"
                        :key="cat.id"
                        class="article-category-card"
                    >
                        <div class="article-category-card-header">
                            <div class="article-category-id-badge">#{{ cat.id }}</div>
                            <div class="article-category-title">{{ cat.title }}</div>
                        </div>

                        <div class="article-category-card-body">
                            <div class="article-category-info-row">
                            ...
                            <div class="article-category-info-row">
                                ...
                                <span class="info-value">{{ cat.parent ? cat.parent.title : '-' }}</span>
                            </div>
                        </div>

                        <div class="article-category-card-actions">
                            <router-link :to="`/articles/categories/${cat.id}/edit`" class="btn btn-sm btn-warning flex-fill">
                                <i class="bi bi-pen"></i>
                                <span>ویرایش</span>
                            </router-link>
...
.article-category-card-actions .btn {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    gap: 4px;
...
.article-category-card-actions .btn span {
    display: none;
}
